...
import { CollectionRef, QueryRef, Ref } from "../../../src/query2/ir.js"
...
describe(`Subquery Caching`, () => {
  ...
  it(`should compile different query objects separately even with shared cache`, () => {
    ...
    expect(subquery1).not.toBe(subquery2)
    ...
    const result2 = compileQuery(subquery2, inputs, sharedCache)
    ...
    expect(sharedCache.has(subquery2)).toBe(true)
  })
