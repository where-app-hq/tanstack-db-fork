...
import { buildQuery } from "../../../src/query2/builder/index.js"
import {
  add,
  and,
  avg,
...
import type { RefProxyFor } from "../../../src/query2/builder/types.js"
import type { RefProxy } from "../../../src/query2/builder/ref-proxy.js"
import type { Agg, Expression } from "../../../src/query2/ir.js"
        ...
        q
          ...
          .select(({ user, dept }) => {
            ...
            expectTypeOf(user.department_id).toEqualTypeOf<
              RefProxy<number | null>
            >()
            expectTypeOf(dept.id).toEqualTypeOf<RefProxy<number>>()
            expectTypeOf(dept.name).toEqualTypeOf<RefProxy<string>>()
            expectTypeOf(dept.budget).toEqualTypeOf<RefProxy<number>>()
