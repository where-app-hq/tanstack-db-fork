...
export default function App() {
  ...
  return (
    <div className="min-h-screen pt-[230px] px-0">
      <div className="min-w-[230px] max-w-[550px] mx-auto relative">
        <h1 className="text-[100px] text-[rgba(175,47,47,0.15)] font-thin text-center mb-8 absolute w-full left-0 top-[-140px]">
          todos
        </h1>
      ...
      <footer className="text-center text-[#bfbfbf] text-[10px] mt-[65px] leading-[1]">
        <p>Double-click to edit a todo</p>
        <p className="mt-2">Created by Cascade</p>
      </footer>
    </div>
  )
}
